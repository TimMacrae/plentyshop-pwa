...
export const useCustomContent = () => {
  ...
  const customImageTextBlock_krautiBottleContent = {
    ...
    description: {
      text: 'Unser Krauti ist kein Likör für Langweiler. Er vereint 27 erlesene Kräuter, Wurzeln und Gewürze zu einem kräftig-würzigen Geschmackserlebnis mit einem einzigem Abgang.',
      color: '#fff',
    },
    cta: {
      text: 'Zum Krauti',
  ...
  const customImageTextBlock_rezepteContent = {
    ...
    subtitle: { text: 'Unsere Rezepte', color: '#fff' },
    description: {
  ...
  return {
    ...
    customImageTextBlock_productSplitti_splittiBottleContent,
