<template>
  <main class="produkte-splitti-page">
    <div v-if="bannerSplitti"><CustomHero :banner="bannerSplitti" /></div>
    ...
    <!-- Image text section -->
    <div v-if="customImageTextBlock_productSplitti_splittiBottleContent">
      <CustomImageTextBlockReverse :data="customImageTextBlock_productSplitti_splittiBottleContent" />
    </div>
